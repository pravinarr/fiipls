...
public class LearnerController {
	...
	public void relearner(DataSetBean bean) throws Exception {
		...
		sav.writetoHdfs(bean, "/usr/local/hadoop/inputToTrain.csv");
	...
	public static void main(String[] args){
		...
		b.setColumnInfo("Age,Gender,AppointmentRegistration,ApointmentData,DayOfTheWeek,Status,Diabetes,Alcoholism,HiperTension,Handcap,Smokes,Scholarship,Tuberculosis,Sms_Reminder,AwaitingTime");
